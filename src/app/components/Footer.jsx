...
export default function Footer() {
    return (
        <div className="mt-5 p-10">
            <p className="text-4xl font-extrabold mt-4 mb-4">Get started today</p>
            <p className="text-gray-500 font-normal sm:w-1/3 mx-auto">We look forward to serving the needs of used cars dealers across the Philippines and helping them thrive in this dynamic market.</p>
            <button
                type="button"
                class="text-white mt-4 bg-[#57009C] hover:bg-[#57009C] focus:ring-4 focus:outline-none focus:-[#57009C] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center"
            >Inquire Now</button>
